...
Design notes
------------
- Mirrors the shape of ``agentx_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the AgentX Agent kanban board.
...
Rules:
  ...
  - Never write "AgentX Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_agentx_home())
        else:

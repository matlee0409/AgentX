...
Both publish at:
  https://agentx-agent.nousresearch.com/docs/llms.txt
  https://agentx-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://agentx-agent.nousresearch.com/docs"
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/agentx-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# AgentX Agent — Full Documentation\n",
        (
            "This file is the entire AgentX Agent documentation concatenated for LLM "
        ...
        "Canonical site: https://agentx-agent.nousresearch.com/docs\n",
        "Short index: https://agentx-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]

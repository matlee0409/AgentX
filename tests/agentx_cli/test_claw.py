...
from agentx_cli import claw as claw_mod
...
class TestCmdMigrate:
    ...
    def test_full_preset_does_not_enable_secrets_silently(self, tmp_path, capsys):
        ...
        even under the 'full' preset.  This mirrors OpenClaw's migrate-agentx
...
class TestPrintMigrationReport:
    ...
    def test_execute_report(self, capsys):
        report = {
            ...
            "output_dir": "/home/user/.agentx/migration/openclaw/20250312T120000",
        }

# AgentX Agent Has Had "Routines" Since March
...
| | Claude Code Routines | AgentX Agent |
|---|---|---|
...
Full automation blueprints gallery: [agentx-agent.nousresearch.com/docs/reference/automation-blueprints-catalog](https://agentx-agent.nousresearch.com/docs/reference/automation-blueprints-catalog)

Documentation: [agentx-agent.nousresearch.com](https://agentx-agent.nousresearch.com)

GitHub: [github.com/NousResearch/agentx-agent](https://github.com/NousResearch/agentx-agent)

---

*AgentX Agent is built by [Nous Research](https://nousresearch.com). Open source, model-agnostic, runs on your infrastructure.*

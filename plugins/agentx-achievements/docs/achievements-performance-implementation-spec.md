...
- persisted runtime files:
  - `~/.agentx/plugins/agentx-achievements/state.json` (existing unlock state)
  - `~/.agentx/plugins/agentx-achievements/scan_snapshot.json` (new)
  - `~/.agentx/plugins/agentx-achievements/scan_checkpoint.json` (new)

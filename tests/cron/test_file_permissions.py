...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("agentx_cli.config.get_config_path", return_value=config_path), \
             patch("agentx_cli.config.ensure_agentx_home"):
    ...
    def test_ensure_agentx_home_sets_0700(self):

...
DOCS_URL = "https://agentx-agent.nousresearch.com/docs/user-guide/features/tool-gateway"
...
def _cmd_login(args) -> int:
    ...
    """
    from agentx_cli.setup import _run_portal_one_shot

...
Built for [AgentX Agent](https://github.com/NousResearch/agentx-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/agentx-agent/skills/creative/ascii-video`](https://github.com/NousResearch/agentx-agent/tree/main/skills/creative/ascii-video) via PR.

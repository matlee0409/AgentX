...
class TestAgentXApiServerToolset:
    """Tests for the agentx-api-server toolset definition."""

    def test_toolset_exists(self):
        ts = get_toolset("agentx-api-server")
        assert ts is not None

    def test_toolset_validates(self):
        assert validate_toolset("agentx-api-server")
...
class TestApiServerPlatformConfig:
    def test_platforms_dict_includes_api_server(self):
        ...
        assert PLATFORMS["api_server"]["default_toolset"] == "agentx-api-server"

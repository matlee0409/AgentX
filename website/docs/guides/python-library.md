...
```bash
pip install git+https://github.com/matlee0409/AgentX.git
```

Or with [uv](https://docs.astral.sh/uv/):

```bash
uv pip install git+https://github.com/matlee0409/AgentX.git
```

You can also pin it in your `requirements.txt`:

```text
agentx-agent @ git+https://github.com/matlee0409/AgentX.git
```

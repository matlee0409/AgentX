"""Tests for _setup_feishu() in agentx_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("agentx_cli.config.save_env_value", side_effect=mock_save), \
         patch("agentx_cli.config.get_env_value", side_effect=mock_get), \
         patch("agentx_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("agentx_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("agentx_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("agentx_cli.cli_output.print_header"), \
         patch("agentx_cli.cli_output.print_info"), \
         patch("agentx_cli.cli_output.print_success"), \
         patch("agentx_cli.cli_output.print_warning"), \
         patch("agentx_cli.cli_output.print_error"), \

...
See the [config reference](https://github.com/matlee0409/AgentX/blob/main/plugins/memory/honcho/README.md) and [Honcho integration guide](https://docs.honcho.dev/v3/guides/integrations/agentx).
...
See [plugin README](https://github.com/matlee0409/AgentX/blob/main/plugins/memory/hindsight/README.md) for the full configuration reference.

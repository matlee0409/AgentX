...
* This module intentionally mirrors ``agentx_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the AgentX Agent board.
...
def _profile_author() -> str:
    """Mirror of ``agentx_cli.kanban._profile_author``. Kept local to

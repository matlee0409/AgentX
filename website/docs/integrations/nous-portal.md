...
If a model is genuinely missing, [open an issue](https://github.com/matlee0409/AgentX/issues) — we surface the Portal's catalog to AgentX and gaps usually mean a routing config we can update.

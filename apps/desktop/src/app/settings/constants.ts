...
export const EMPTY_SELECT_VALUE = '__agentx_empty__'
...
export const ENUM_OPTIONS: Record<string, string[]> = {
  ...
  // agentx_cli/config.py (local/groq/openai/mistral/elevenlabs).
...
export const FIELD_DESCRIPTIONS: Record<string, string> = defineFieldCopy({
  ...
  timezone: 'Used when AgentX needs local time context. Blank uses the system timezone.',
  agent: {

...
export const zhHant = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingAgentXDesktop: '正在啟動 AgentX Desktop…'
    },
    errors: {
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed: '桌面後端拒絕了該請求 (405 Method Not Allowed)。請嘗試重新啟動 AgentX Desktop。',
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverride: '環境變數覆寫',
      intro:
        'AgentX Desktop 預設會啟動自己的本機閘道。如果您希望此應用程式控制另一台機器或可信代理後面已執行的 AgentX 後端，請使用遠端閘道。在下方按設定檔指定各自的遠端主機。',
      appliesTo: '套用至',
      allProfiles: '全部設定檔',
      ...
      savedTitle: '閘道設定已儲存',
      restartingMessage: 'AgentX Desktop 將使用已儲存的設定重新連線。',
  ...
  commandCenter: {
    ...
    agentxActiveSessions: (version, count) => `AgentX ${version} · 活躍工作階段 ${count}`,
  ...
  install: {
    ...
    failedTitle: '安裝失敗',
    settingUpTitle: '正在設定 AgentX Agent',
    finishingTitle: '正在收尾',
    failedDesc:
  ...
  desktop: {
    ...
    restartToUseSaveImage: '重新啟動 AgentX Desktop 後可使用儲存圖片。',
    restartToSaveImages: '重新啟動 AgentX Desktop 以儲存圖片',

...
class DistributionManifest:
    ...
    def from_dict(cls, data: Any) -> "DistributionManifest":
        ...
        return cls(
            ...
            description=str(data.get("description") or ""),
            agentx_requires=str(data.get("agentx_requires") or ""),
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.agentx_requires:
            out["agentx_requires"] = self.agentx_requires
        if self.author:
...
def check_agentx_requires(spec: str, current_version: str) -> None:
...
def plan_install(
    ...
    check_agentx_requires(manifest.agentx_requires, agentx_version)
...
def install_distribution(
    ...
    with tempfile.TemporaryDirectory(prefix="agentx_dist_install_") as tmp:
...
def update_distribution(
    ...
    with tempfile.TemporaryDirectory(prefix="agentx_dist_update_") as tmp:
        plan = plan_install(

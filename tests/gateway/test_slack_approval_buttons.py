...
class TestSlackExecApproval:
    ...
    async def test_sends_blocks_with_buttons(self):
        ...
        assert "agentx_approve_once" in action_ids
        assert "agentx_approve_session" in action_ids
        assert "agentx_approve_always" in action_ids
        assert "agentx_deny" in action_ids
...
class TestSlackApprovalAction:
    ...
    async def test_deny_action(self):
        ...
        action = {"action_id": "agentx_deny", "value": "session-key"}

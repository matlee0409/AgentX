...
import type { AgentXConfigRecord } from '@/types/agentx'

import { CONTROL_TEXT } from './constants'
import { getNested, setNested } from './helpers'
import { ListRow, LoadingState, Pill, SectionHeading } from './primitives'

// AgentX' reasoning levels (VALID_REASONING_EFFORTS); `none` = thinking off.
// Empty config = AgentX default (medium), shown as Medium.
...
// Mirrors `_AUX_TASK_SLOTS` in agentx_cli/web_server.py. Friendly labels and

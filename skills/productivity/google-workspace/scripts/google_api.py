#!/usr/bin/env python3
"""Google Workspace API CLI for AgentX Agent.
...
from _agentx_home import get_agentx_home
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for AgentX Agent")

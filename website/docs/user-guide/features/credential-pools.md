...
anthropic (3 credentials):
  #1  agentx_pkce          oauth   agentx_pkce ←
...
2. **`agentx_cli/auth_commands.py`** — CLI commands and interactive wizard
3. **`agentx_cli/runtime_provider.py`** — Pool-aware credential resolution

...
export class AgentXGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
...
export function getAgentXConfig(): Promise<AgentXConfig> {
  return window.agentxDesktop.api<AgentXConfig>({
    ...profileScoped(),
    path: '/api/config'
  })
}

export function getAgentXConfigRecord(): Promise<AgentXConfigRecord> {
  return window.agentxDesktop.api<AgentXConfigRecord>({
    ...profileScoped(),
    path: '/api/config'
  })
}

export function getAgentXConfigDefaults(): Promise<AgentXConfigRecord> {
  return window.agentxDesktop.api<AgentXConfigRecord>({
    ...profileScoped(),
...
export function getAgentXConfigSchema(): Promise<ConfigSchemaResponse> {
...
export function saveAgentXConfig(config: AgentXConfigRecord): Promise<{ ok: boolean }> {
  return window.agentxDesktop.api<{ ok: boolean }>({
    ...profileScoped(),
    path: '/api/config',
    method: 'PUT',
...
export function selectToolsetProvider(
  ...
  return window.agentxDesktop.api<{ ok: boolean; name: string; provider: string }>({
    ...profileScoped(),
...
export function updateAgentX(): Promise<ActionResponse> {
  return window.agentxDesktop.api<ActionResponse>({
    ...profileScoped(),
...
export function checkAgentXUpdate(force = false): Promise<BackendUpdateCheckResponse> {

"""Tests for agentx_cli/skills_config.py and skills_tool disabled filtering."""
...
class TestSaveDisabledSkills:
    @patch("agentx_cli.skills_config.save_config")
    def test_saves_global_sorted(self, mock_save):
        from agentx_cli.skills_config import save_disabled_skills
        config = {}
...
class TestIsSkillDisabled:
    @patch("agentx_cli.config.load_config")
...
class TestGetDisabledSkillNames:
    ...
    def test_agentx_platform_takes_precedence(self, tmp_path, monkeypatch):
...
class TestGetCategories:
    def test_extracts_unique_categories(self):
        from agentx_cli.skills_config import _get_categories
        skills = [

...
{ inputs, ... }: {
  ...
  in {
    options.services.agentx-agent = with lib; {
      enable = mkEnableOption "AgentX Agent gateway service";
      ...
      environmentFiles = mkOption {
        ...
        description = ''
          ...
          AgentX reads this file on every startup via load_agentx_dotenv().
        '';
      };
      ...
      extraPythonPackages = mkOption {
        ...
        description = ''
          ...
          agentx_agent.plugins entry-point group. Each package must be built
    ...
    exec_user=${cfg.user}
    agentx_bin=${containerDataDir}/current-package/bin/agentx
    AGENTX_CONTAINER_MODE_EOF
          ...
          # AgentX reads $AGENTX_HOME/.env at startup via load_agentx_dotenv(),
    ...
    AGENTX_NIX_ENV_EOF
      ...
      (lib.mkIf (!cfg.container.enable) {
        systemd.services.agentx-agent = {
          description = "AgentX Agent Gateway";
          ...
          serviceConfig = {
            ...
            # $AGENTX_HOME/.env by the activation script. load_agentx_dotenv()
      ...
      (lib.mkIf cfg.container.enable {
        ...
        systemd.services.agentx-agent = {
          description = "AgentX Agent Gateway (container)";
          wantedBy = [ "multi-user.target" ];
          after = [ "network-online.target" ]

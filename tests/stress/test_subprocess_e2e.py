...
This validates the IPC + lifecycle story that mocks can't:
  ...
  - the child process resolves agentx_cli.kanban_db on its own
...
def main():
    home = tempfile.mkdtemp(prefix="agentx_e2e_")
...
""")
    ...
    print("=" * 60)
    # Scenario A workers wrote to /tmp/agentx_e2e_*/worker_*.log
    import glob

...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("update", "Update AgentX Agent to the latest version", "Info"),
    CommandDef("version", "Show AgentX Agent version", "Info", aliases=("v",)),
...
def _iter_plugin_command_entries() -> list[tuple[str, str, str]]:
    ...
    :func:`agentx_cli.plugins.PluginContext.register_command`. They behave
...
#   - credits: the billing/top-up surface; reached via /agentx credits on Slack.
#   - billing: the terminal-billing surface (buy/auto-reload/limit); /agentx billing.
...
_SLACK_VIA_AGENTX_ONLY = frozenset({"credits", "billing", "moa", "debug"})

...
Data file: $AGENTX_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_AGENTX_HOME = Path(os.environ.get("AGENTX_HOME", Path.home() / ".agentx"))
DATA_DIR = _AGENTX_HOME / "skills" / "productivity" / "memento-flashcards" / "data"

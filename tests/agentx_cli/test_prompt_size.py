...
from agentx_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(agentx_home, memory_text="", user_text=""):
    mem_dir = agentx_home / "memories"
...
def _seed_skill(agentx_home, name, description):
    skill_dir = agentx_home / "skills" / "demo" / name

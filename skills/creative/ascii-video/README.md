...
Built for [AgentX Agent](https://github.com/matlek0409/AgentX). Usable in any coding agent. Canonical source lives here; synced to [`matlek0409/AgentX/skills/creative/ascii-video`](https://github.com/matlek0409/AgentX/tree/main/skills/creative/ascii-video) via PR.

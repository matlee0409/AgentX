...
def build_user_agent() -> str:
    ...
    Format::
        ...
        QQBotAdapter/<qqbot_version> (Python/<py_version>; <os>; AgentX/<agentx_version>)
    ...
    agentx_version = _get_agentx_version()
    return f"QQBotAdapter/{QQBOT_VERSION} (Python/{py_version}; {os_name}; AgentX/{agentx_version})"

...
interface GatewayBootOptions {
  ...
  onGatewayReady: (gateway: AgentXGateway | null) => void
...
export function useGatewayBoot({
  ...
  useEffect(() => {
    ...
    const publish = (next: AgentXConnection | null) => {
    ...
    const attemptReconnect = async () => {
      ...
      try {
        ...
        await callbacksRef.current.refreshAgentXConfig().catch(() => undefined)
    ...
    async function boot() {
      try {
        ...
        await callbacksRef.current.refreshAgentXConfig()

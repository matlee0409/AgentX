...
_USER_NAMESPACE = "_agentx_user_cron"


def _register_synthetic_package(name: str, search_locations: List[str]) -> None:
    """Register an empty package shell in sys.modules.

    User-installed providers import as ``_agentx_user_cron.<name>``, a dotted
    ...
    ``ModuleNotFoundError: No module named '_agentx_user_cron'`` — the same

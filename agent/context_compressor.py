...
# heuristics. See https://github.com/NousResearch/agentx-agent/issues/38389
#
...
Summary generation was unavailable, so this is a best-effort deterministic fallback for {len(turns_to_summarize)} compacted message(s).{reason_text}"""
    ...
    def _generate_summary(
        ...
        # user's configured timezone via agentx_time.now(). The compaction summary
        ...
        try:
            ...
            _today_str = _agentx_now().strftime("%Y-%m-%d")

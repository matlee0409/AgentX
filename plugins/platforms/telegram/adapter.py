...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            try:
                ...
                from agentx_cli.commands import telegram_menu_commands, telegram_menu_max_commands
    ...
    def _build_provider_keyboard(self, providers: list):
        ...
        """
        try:
            from agentx_cli.models import group_providers
        except Exception:
    ...
    async def _handle_model_picker_callback(
        ...
        if data.startswith("mp:"):
            ...
            group_id = data[4:]
            try:
                from agentx_cli.models import PROVIDER_GROUPS
...
# agentx_cli/{setup,gateway}.py, and the _send_telegram dispatch in
...
def interactive_setup() -> None:
    ...
    _PLATFORMS["telegram"] static dict dispatch in agentx_cli/gateway.py.
    """
    from agentx_cli import setup as _setup_mod
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install 'agentx-agent[telegram]'",

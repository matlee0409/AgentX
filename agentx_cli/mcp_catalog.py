...
from agentx_constants import get_agentx_home, get_optional_mcps_dir
...
from agentx_cli.cli_output import prompt as _prompt_input
...
def _install_root() -> Path:
    ...
    root = get_agentx_home() / "mcp-installs"

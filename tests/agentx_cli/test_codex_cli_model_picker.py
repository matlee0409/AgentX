...
@pytest.fixture()
def agentx_auth_only_env(tmp_path, monkeypatch):
...
def test_normal_path_still_works(agentx_auth_only_env):
...
def test_codex_picker_uses_live_codex_catalog(agentx_auth_only_env, tmp_path, monkeypatch):

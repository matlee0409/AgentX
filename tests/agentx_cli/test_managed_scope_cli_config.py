...
agentx_cli.config._load_config_impl, so the managed-scope merge has to be
...
def _load_cli_config(home):
    ...
    cli.py binds ``_agentx_home = get_agentx_home()`` at import time (module

...
AgentX Agent connects to external systems for AI inference, tool servers, IDE workflows, programmatic access, and more. These integrations extend what AgentX can do and where it can run.
...
- **[AI Providers](/user-guide/features/provider-routing)** — OpenRouter, Anthropic, OpenAI, Google, and any OpenAI-compatible endpoint. AgentX auto-detects capabilities like vision, streaming, and tool use per provider.
...
- **[IDE Integration (ACP)](/user-guide/features/acp)** — Use AgentX Agent inside ACP-compatible editors such as VS Code, Zed, and JetBrains. AgentX runs as an ACP server, rendering chat messages, tool activity, file diffs, and terminal commands inside your editor.
...
- **[Build a Plugin](/guides/build-a-agentx-plugin)** — Step-by-step guide for creating AgentX plugins with tools, hooks, and CLI commands.

...
description: "How to create skills for AgentX Agent — SKILL.md format, guidelines, and publishing"
---

# Creating Skills

Skills are the preferred way to add new capabilities to AgentX Agent. They're easier to create than tools, require no code changes to the agent, and can be shared with the community.
...
A **blueprint** is an ordinary skill that additionally declares a schedule in its frontmatter. Add a `metadata.agentx.blueprint` block and the skill becomes a shareable, runnable automation:

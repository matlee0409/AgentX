 ...
 * origin=git@github.com:matlee0409/AgentX.git. A background
...
test('canonicalGitHubRemote normalizes SSH and HTTPS forms to the same value', () => {
  assert.equal(canonicalGitHubRemote('git@github.com:matlee0409/AgentX.git'), OFFICIAL_REPO_CANONICAL)
  assert.equal(canonicalGitHubRemote('git@github.com:matlee0409/AgentX'), OFFICIAL_REPO_CANONICAL)
  assert.equal(canonicalGitHubRemote('ssh://git@github.com/matlee0409/AgentX.git'), OFFICIAL_REPO_CANONICAL)
  assert.equal(canonicalGitHubRemote('https://github.com/matlee0409/AgentX.git'), OFFICIAL_REPO_CANONICAL)
  ...
  assert.equal(canonicalGitHubRemote('https://github.com/matlee0409/AgentX/'), OFFICIAL_REPO_CANONICAL)
})
...
test('isSshRemote detects scp-like and ssh:// forms only', () => {
  assert.equal(isSshRemote('git@github.com:matlee0409/AgentX.git'), true)
  assert.equal(isSshRemote('ssh://git@github.com/matlee0409/AgentX.git'), true)
  assert.equal(isSshRemote('https://github.com/matlee0409/AgentX.git'), false)
...
test('isOfficialSshRemote is true only for the official repo over SSH', () => {
  assert.equal(isOfficialSshRemote('git@github.com:matlee0409/AgentX.git'), true)
  assert.equal(isOfficialSshRemote('git@github.com:matlee0409/AgentX'), true)
  assert.equal(isOfficialSshRemote('ssh://git@github.com/matlee0409/AgentX.git'), true)
...
test('isOfficialSshRemote does NOT match forks, other hosts, or HTTPS', () => {
  ...
  assert.equal(isOfficialSshRemote('git@gitlab.com:matlee0409/AgentX.git'), false)
  ...
  assert.equal(isOfficialSshRemote('https://github.com/matlee0409/AgentX.git'), false)

...
DEFAULT_CATALOG_URL = (
    "https://agentx-agent.nousresearch.com/docs/api/model-catalog.json"
)
...
DEFAULT_CATALOG_FALLBACK_URLS: tuple[str, ...] = (
    "https://raw.githubusercontent.com/NousResearch/agentx-agent/main/website/static/api/model-catalog.json",
)
DEFAULT_TTL_HOURS = 1
...
def _cache_path() -> Path:
    ...
    return get_agentx_home() / "cache" / "model_catalog.json"

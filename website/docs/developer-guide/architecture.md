...
sidebar_position: 1
title: "Architecture"
description: "AgentX Agent internals — major subsystems, execution paths, data flow, and where to read next"
---

# Architecture

This page is the top-level map of AgentX Agent internals. Use it to orient yourself in the codebase, then dive into subsystem-specific docs for implementation details.
...
│ agentx_state.py   │              │ Browser (5 backends)  │
...
├── cli.py                    # AgentXCLI — interactive terminal UI (large file)
├── model_tools.py            # Tool discovery, schema collection, dispatch
├── toolsets.py               # Tool groupings and platform presets
├── agentx_state.py           # SQLite session/state database with FTS5
├── agentx_constants.py       # AGENTX_HOME, profile-aware paths
...
│
├── agentx_cli/               # CLI subcommands and setup
...
```text
User input → AgentXCLI.process_input()
...
→ [Plugin Guide](/guides/build-a-agentx-plugin), [Memory Provider Plugin](./memory-provider-plugin.md)

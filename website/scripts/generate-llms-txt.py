...
Both publish at:
  https://github.com/matlee0409/AgentX/wiki/llms.txt
  https://github.com/matlee0409/AgentX/wiki/llms-full.txt
...
SITE_BASE = "https://github.com/matlee0409/AgentX/wiki"
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append("Repo: https://github.com/matlee0409/AgentX")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://github.com/matlee0409/AgentX/wiki\n",
        "Short index: https://github.com/matlee0409/AgentX/wiki/llms.txt\n",
        "\n---\n\n",
    ]

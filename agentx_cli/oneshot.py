...
def _create_session_db_for_oneshot():
    ...
    Oneshot bypasses ``AgentXCLI._init_agent()``, so it must wire the SQLite
...
def _run_agent(
    ...
    from agentx_cli.models import detect_provider_for_model
    ...
    if effective_provider is None and (model or env_model):
        ...
        if explicit_model:
            ...
            try:
                from agentx_cli import model_switch as _ms

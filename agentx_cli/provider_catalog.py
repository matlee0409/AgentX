...
they were not: the CLI picker read :data:`agentx_cli.models.CANONICAL_PROVIDERS`
...
* ``auth_type`` / ``api_key_env_vars`` / ``base_url_env_var`` from
  :data:`agentx_cli.auth.PROVIDER_REGISTRY` (credential truth), and
...
# agentx_cli.auth.PROVIDER_REGISTRY and providers.base.ProviderProfile.

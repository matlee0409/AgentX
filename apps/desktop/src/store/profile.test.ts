...
import type { AgentXConnection } from '@/global'
...
const remoteConn = (over: Partial<AgentXConnection> = {}): AgentXConnection =>
  ({ baseUrl: 'https://agentx-roy.tail.ts.net', mode: 'remote', profile: 'vps-remote', ...over }) as AgentXConnection

const localConn = (over: Partial<AgentXConnection> = {}): AgentXConnection =>
  ({ baseUrl: '', mode: 'local', profile: 'default', ...over }) as AgentXConnection

const getConnection = vi.fn<(profile?: string | null) => Promise<AgentXConnection>>()

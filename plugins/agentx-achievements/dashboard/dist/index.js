(function () {
  "use strict";
  // agentx-achievements dashboard plugin
  // Originally authored by @PCinkusz — https://github.com/PCinkusz/agentx-achievements (MIT).
  ...
  function api(path, options) {
    ...
    // gated OAuth (agentx_session_at cookie via credentials:'include').
    ...
    const url = "/api/plugins/agentx-achievements" + path;
  ...
  async function buildShareImage(achievement) {
    ...
    ctx.fillText("AGENTX AGENT  ·  agentx-agent.nousresearch.com", 70, H - 40);
  ...
  function ShareDialog({ achievement, onClose }) {
    ...
    function tweetText() {
      ...
      const tmpl = tx(t, "share.tweet_text", "Just unlocked {tier_part}\"{name}\" in AgentX Agent ☤", {
        tier_part: tierPart,
        name: achievement.name,
      });
      return tmpl + "\n\n@NousResearch · https://agentx-agent.nousresearch.com";
    }
  ...
  window.__AGENTX_PLUGINS__.register("agentx-achievements", AchievementsPage);
})();

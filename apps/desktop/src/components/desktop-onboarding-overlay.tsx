...
import { getGlobalModelOptions } from '@/agentx'
...
import type { ModelOptionProvider, OAuthProvider } from '@/types/agentx'
...
const API_KEY_OPTIONS: ApiKeyOption[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://github.com/NousResearch/agentx-agent#bring-your-own-endpoint',

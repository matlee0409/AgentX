...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingAgentXDesktop: 'Starting AgentX Desktop…'
    },
    errors: {
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting AgentX Desktop.',
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'AgentX Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running AgentX backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      remoteDesc:
        'Connect this desktop shell to a remote AgentX backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'AgentX Desktop will reconnect using the saved settings.',
  ...
  commandCenter: {
    ...
    agentxActiveSessions: (version, count) => `AgentX ${version} · Active sessions ${count}`,
  ...
  install: {
    ...
    settingUpTitle: 'Setting up AgentX Agent',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with AgentX Agent",
    ...
    flowSubtitles: {
      ...
      loopback: 'Opens your browser to sign in — AgentX connects automatically',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `AgentX Desktop v${version}`,
      ...
      gatewayTitle: 'AgentX inference gateway status',
      agents: 'Agents',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart AgentX Desktop to use Save Image.',
    restartToSaveImages: 'Restart AgentX Desktop to save images',

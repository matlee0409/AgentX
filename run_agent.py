...
from agentx_cli.timeouts import (
...
_loaded_env_paths = load_agentx_dotenv(agentx_home=_agentx_home, project_env=_project_env)
...
def _routermint_headers() -> dict:
    ...
    return {
        "User-Agent": f"AgentXAgent/{_AGENTX_VERSION}",
    }
...
class AIAgent:
    ...
    def _ensure_lmstudio_runtime_loaded(self, config_context_length: Optional[int] = None) -> None:
        """
        Preload the LM Studio model with at least AgentX' minimum context.
        """
        if (self.provider or "").strip().lower() != "lmstudio":
            return
        try:
            from agent.model_metadata import MINIMUM_CONTEXT_LENGTH
            from agentx_cli.models import ensure_lmstudio_model_loaded
    ...
    def _invoke_api_request_error_hook(
        ...
        *,
        ...
        # ``monkeypatch.setattr("agentx_cli.plugins.has_hook", ...)`` still
        ...
        try:
            from agentx_cli import plugins as _plugins
    ...
    def _try_refresh_copilot_client_credentials(self) -> bool:
        ...
        try:
            from agentx_cli.copilot_auth import resolve_copilot_token
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if (
            ...
            try:
                from agentx_cli.models import github_model_reasoning_efforts
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        if cached is not None:
            ...
            if opts or (_time.monotonic() - ts) < 60:
                return opts
        try:
            from agentx_cli.models import lmstudio_model_reasoning_options

...
Message-template support (the workaround for outside-window sends) is not yet implemented in AgentX. If you need it, please [open an issue](https://github.com/matlee0409/AgentX/issues) — it's planned but waiting on a clear demand signal.

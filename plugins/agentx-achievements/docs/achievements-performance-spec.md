...
Owner: agentx-achievements plugin
...
### `GET /api/plugins/agentx-achievements/achievements`
...
### `POST /api/plugins/agentx-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/plugins/agentx-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/plugins/agentx-achievements/overview`
...
- Persist plugin data under:
  - `~/.agentx/plugins/agentx-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.agentx/plugins/agentx-achievements/scan_checkpoint.json`
...
- `~/.agentx/plugins/agentx-achievements/`

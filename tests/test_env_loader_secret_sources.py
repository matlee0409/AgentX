"""Tests for the secret-source tracking in ``agentx_cli.env_loader``.
...
from agentx_cli import env_loader  # noqa: E402
...
def test_apply_external_secret_sources_dedupes_within_process(tmp_path, monkeypatch):
    """``load_agentx_dotenv()`` is called at module-import time from several
    hot modules (cli.py, agentx_cli/main.py, run_agent.py, ...).  The
    ...
    # cli.py, agentx_cli/main.py, run_agent.py, trajectory_compressor.py,

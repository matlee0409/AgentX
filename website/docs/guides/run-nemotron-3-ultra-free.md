---
sidebar_position: 0
title: "Run Nemotron 3 Ultra free in AgentX Agent"
description: "Try NVIDIA Nemotron 3 Ultra on Nous Portal — free June 4–18 — with day 0 support in AgentX Agent"
---

# Run Nemotron 3 Ultra free in AgentX Agent

Nous Research has been inducted into the **Nemotron Coalition** of leading AI labs working with **NVIDIA** to advance open frontier foundation models. In honor of this, we've partnered with **Nebius** to provide **Nemotron 3 Ultra** free on [Nous Portal](https://portal.nousresearch.com) for two weeks (**June 4th – June 18th**). Follow the instructions below to try the model in your AgentX Agent today.
...
[Download the AgentX Desktop installer](https://agentx-agent.nousresearch.com/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).
...
Prefer to review first? Download [`install.sh`](https://agentx-agent.nousresearch.com/install.sh), inspect it, then run it.
...
When prompted to connect your account to AgentX Agent, click **Connect**. You'll see a confirmation once it's linked.
...
- **[Run AgentX Agent with Nous Portal](/guides/run-agentx-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification

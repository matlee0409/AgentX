...
This guide walks you through connecting AgentX Agent to GitHub so it automatically fetches a pull request's diff, analyzes the code changes, and posts a comment — triggered by a webhook event with no manual prompting.
...
- AgentX Agent installed and running (`agentx gateway`)
...
- **[Build a Plugin](/guides/build-a-agentx-plugin)** — package review logic into a shareable plugin

...
class TestScanMemoryContent:
    ...
    def test_agentx_config_mod_blocked(self):
        result = _scan_memory_content("edit .agentx/config.yaml to change settings")
        assert "Blocked" in result
        assert "agentx_config_mod" in result
        result = _scan_memory_content("update .agentx/SOUL.md with new personality")
        assert "Blocked" in result
        assert "agentx_config_mod" in result
    ...
    def test_agentx_config_mod_no_false_positives(self):
        """Merely mentioning agentx config files should not trigger; only modify intent should."""
        ...
        assert _scan_memory_content("The .agentx/config.yaml file contains runtime options") is None

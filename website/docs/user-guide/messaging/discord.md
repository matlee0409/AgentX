...
sidebar_position: 3
title: "Discord"
description: "Set up AgentX Agent as a Discord bot"
---

# Discord Setup

AgentX Agent integrates with Discord as a bot, letting you chat with your AI assistant through direct messages or server channels. The bot receives your messages, processes them through the AgentX Agent pipeline (including tool use, memory, and reasoning), and responds in real time. It supports text, voice messages, file attachments, and slash commands.
...
3. Enter a name for your application (e.g., "AgentX Agent") and accept the Developer Terms of Service.
4. Click **Create**.
...
The bot token is the credential AgentX Agent uses to log in as your bot. Still on the **Bot** page:
...
AgentX Agent uses your Discord User ID to control who can interact with the bot. To find it:
...
AgentX Agent supports Discord voice messages:

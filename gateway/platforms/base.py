...
from agentx_constants import get_default_agentx_root, get_agentx_dir, get_agentx_home
...
# Default location: {AGENTX_HOME}/cache/images/ (legacy: image_cache/)
IMAGE_CACHE_DIR = get_agentx_dir("cache/images", "image_cache")
...
AUDIO_CACHE_DIR = get_agentx_dir("cache/audio", "audio_cache")
...
VIDEO_CACHE_DIR = get_agentx_dir("cache/videos", "video_cache")
...
DOCUMENT_CACHE_DIR = get_agentx_dir("cache/documents", "document_cache")
SCREENSHOT_CACHE_DIR = get_agentx_dir("cache/screenshots", "browser_screenshots")
_AGENTX_HOME = get_agentx_home()
_AGENTX_ROOT = get_default_agentx_root()
...
def _media_delivery_denied_paths() -> List[Path]:
    ...
    for agentx_root in (_AGENTX_HOME, _AGENTX_ROOT):
        for rel in _ROOT_CREDENTIAL_FILES:
            denied.append(agentx_root / rel)
...
class BasePlatformAdapter(ABC):
    ...
    async def handle_message(self, event: MessageEvent) -> None:
        ...
        if session_key in self._active_sessions:
            ...
            from agentx_cli.commands import should_bypass_active_session
    ...
    async def _process_message_background(self, event: MessageEvent, session_key: str) -> None:
        ...
        try:
            ...
            # not at the top of this task.  _agentx_run_generation is set on

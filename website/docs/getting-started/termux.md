...
description: "Run AgentX Agent directly on an Android phone with Termux"
---
...
AgentX Agent can run directly on an Android phone through [Termux](https://termux.dev/).

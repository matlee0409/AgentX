...
# tests/openviking_plugin/test_openviking.py::test_skill_markers_match_agentx_scaffolding.
# ---------------------------------------------------------------------------
...
def _load_skill_payload(skill_identifier: str, task_id: str | None = None) -> tuple[dict[str, Any], Path | None, str] | None:
    ...
    try:
        ...
        if identifier_path.is_absolute():
            ...
            # find a skill via ~/.agentx/skills/<name> where <name> is a
...
def _inject_skill_config(loaded_skill: dict[str, Any], parts: list[str]) -> None:
    ...
    If the loaded skill's frontmatter declares ``metadata.agentx.config``
    ...
    try:
        ...
        lines = ["", f"[Skill config (from {display_agentx_home()}/config.yaml):"]

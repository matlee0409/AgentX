...
# Must match agentx_cli.runtime_provider.RUNTIME_PROVIDER_TYPE_CUSTOM.
...
# (agentx-* prefixed), and scenario toolsets.
#
...
_SUBAGENT_TOOLSETS = sorted(
    ...
    and not name.startswith("agentx-")
...
def _load_config() -> dict:
    ...
    to the persistent config (agentx_cli/config.py load_config()) so that
        ...
        "properties": {
            ...
            "acp_command": {
                ...
                "description": (
                    ...
                    "Leave empty to use the parent's default transport (AgentX subagents)."
                ),
            },
            "acp_args": {
                "type": "array",

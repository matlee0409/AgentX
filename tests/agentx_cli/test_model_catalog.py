"""Tests for agentx_cli.model_catalog — remote manifest fetch + cache + fallback."""
...
def isolated_home(tmp_path, monkeypatch):
    ...
    import importlib
    from agentx_cli import model_catalog
...
class TestValidation:
    def test_accepts_well_formed_manifest(self, isolated_home):
        from agentx_cli.model_catalog import _validate_manifest
...
class TestFallbackChain:
    ...
    PRIMARY = "https://agentx-agent.nousresearch.com/docs/api/model-catalog.json"
    FALLBACK = (
        "https://raw.githubusercontent.com/NousResearch/agentx-agent"
...
class TestIntegrationWithModelsModule:
    """Exercise the fallback paths via the real callers in agentx_cli.models."""

    def test_curated_nous_ids_falls_back_to_hardcoded_on_empty_catalog(
        self, isolated_home
    ):
        from agentx_cli import model_catalog
        from agentx_cli.models import get_curated_nous_model_ids, _PROVIDER_MODELS
    ...
    def test_curated_nous_ids_prefers_manifest(self, isolated_home):
        from agentx_cli import model_catalog
        from agentx_cli.models import get_curated_nous_model_ids
    ...
    def test_picker_nous_row_uses_curated_list(self, tmp_path, monkeypatch):
        ...
        importlib.reload(model_catalog)
        try:
            from agentx_cli.model_switch import list_picker_providers
            ...
            with patch.object(
                model_catalog, "_fetch_manifest", return_value=_valid_manifest()
            ), patch("agentx_cli.models.check_nous_free_tier", return_value=False), patch(
                "agentx_cli.models.union_with_portal_free_recommendations",

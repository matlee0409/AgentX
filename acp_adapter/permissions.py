...
def _map_outcome_to_agentx(outcome: object, *, allowed_option_ids: set[str]) -> str:
    ...
    if option_id not in allowed_option_ids:
        ...
        return "deny"
    return _OPTION_ID_TO_AGENTX.get(option_id, "deny")

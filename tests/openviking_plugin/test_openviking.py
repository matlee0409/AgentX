...
class TestOpenVikingSkillQuerySafety:
    ...
    def test_skill_markers_match_agentx_scaffolding(self, tmp_path, monkeypatch):
...
class TestOpenVikingTurnConversion:
            ...
            turn = [
                ...
                },
                {
                    ...
                    "content": json.dumps({
                        "results": [
                            {
                                "uri": "viking://user/agentx/memories/context",
    ...
    def test_messages_to_openviking_batch_adds_assistant_peer_id_when_requested(self):
        ...
        assert batch == [
            {"role": "user", "parts": [{"type": "text", "text": "hello"}]},
            {"role": "assistant", "parts": [{"type": "text", "text": "answer"}], "peer_id": "agentx"},
        ]
...
class TestOpenVikingRead:
        ...
        provider._client = FakeVikingClient(
            {
                (
                    "/api/v1/content/read",
                    (("uri", "viking://user/agentx/memories/profile.md"),),
                ): {"result": "full text"},
            }
        )

        result = json.loads(provider._tool_read({"uri": "viking://user/agentx/memories/profile.md", "level": "full"}))

        assert result["uri"] == "viking://user/agentx/memories/profile.md"
        assert result["resolved_uri"] == "viking://user/agentx/memories/profile.md"
    ...
    def test_read_deduplicates_uri_batch_and_keeps_errors_per_uri(self):
        provider = OpenVikingMemoryProvider()
        ok_uri = "viking://user/agentx/memories/ok.md"
        bad_uri = "viking://user/agentx/memories/bad.md"
        provider._client = FakeVikingClient(
            {
                (
                    "/api/v1/content/read",
    ...
    def test_overview_file_uri_routes_straight_to_content_read_via_stat_probe(self):
        ...
        provider = OpenVikingMemoryProvider()
        file_uri = "viking://user/agentx/memories/entities/mem_abc.md"
        provider._client = FakeVikingClient(
            {
                (
                    "/api/v1/fs/stat",
    ...
    def test_overview_directory_uri_uses_stat_probe_then_overview(self):
        ...
        provider = OpenVikingMemoryProvider()
        dir_uri = "viking://user/agentx/memories"
        provider._client = FakeVikingClient(
            {
                (
                    "/api/v1/fs/stat",
        ...
        responses = {
            (
                ...
                "result": {
                    "memories": [
                        {
                            "uri": "viking://user/peers/agentx/memories/caroline.md",
                            "score": 0.9,
                            "level": 1,
                            "category": "profile",
        ...
        responses = {
            ...
            (
                ...
                "result": {
                    "memories": [
                        {
                            "uri": "viking://user/peers/agentx/memories/melanie-race.md",
                            "score": 0.9,
                            "level": 1,
                            "category": "events",
        ...
        responses = {
            ("/api/v1/search/search", "memory", "What should we recall?", "session-test"): {
                "result": {
                    "memories": [
                        {
                            "uri": "viking://user/peers/agentx/memories/keep.md",
                            "score": 0.22,
                            "level": 1,
                        ...
                        {
                            "uri": "viking://user/peers/agentx/memories/drop.md",
                            "score": 0.12,
                            "level": 1,
                            "category": "preferences",
        ...
        responses = {
            ("/api/v1/search/search", "memory", "What should we recall?", "session-test"): {
                "result": {
                    "memories": [
                        {
                            "uri": "viking://user/peers/agentx/memories/too-large.md",
                            "score": 0.9,
                            "level": 1,
                            "category": "memory",
                        ...
                        {
                            "uri": "viking://user/peers/agentx/memories/small.md",
                            "score": 0.8,
                            "level": 1,
                            "category": "memory",
        ...
        responses = {
            ("/api/v1/search/search", "memory", "What should we recall?", "session-test"): {
                "result": {
                    "memories": [
                        {
                            "uri": "viking://user/peers/agentx/memories/full.md",
                            "score": 0.9,
                            "level": 2,
                            "category": "events",
            ...
            ("/api/v1/content/read", "viking://user/peers/agentx/memories/full.md"): {

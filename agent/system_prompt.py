...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    if active_profile == "default":
        stable_parts.append(
            ...
            "under ~/.agentx/profiles/<name>/. Each profile has its own "
        ...
        stable_parts.append(
            ...
            f"and writes ~/.agentx/profiles/{active_profile}/. The default "
            f"profile's data lives at ~/.agentx/skills/, ~/.agentx/plugins/, "
            f"~/.agentx/cron/, ~/.agentx/memories/ — those belong to a "
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — AgentX never rebuilds or reinjects parts of it

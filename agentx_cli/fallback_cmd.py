...
def _restore_auth_active_provider(value: Any) -> None:
    ...
    try:
        from agentx_cli.auth import _auth_store_lock, _load_auth_store, _save_auth_store
...
def cmd_fallback_list(args) -> None:  # noqa: ARG001
    ...
    print("  Docs: https://agentx-agent.nousresearch.com/docs/user-guide/features/fallback-providers")
    print()
...
def cmd_fallback_add(args) -> None:
    ...
    from agentx_cli.main import _require_tty, select_provider_and_model

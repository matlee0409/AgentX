"""
Skills configuration for AgentX Agent.
...
from agentx_cli.config import cfg_get, load_config, save_config
from agentx_cli.colors import Colors, color
from agentx_cli.platforms import PLATFORMS as _PLATFORMS

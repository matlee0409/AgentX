...
TIPS = [
    ...
    "agentx chat --max-turns 200 overrides the default 90-iteration limit per turn.",
    ...
    'AGENTX_WRITE_SAFE_ROOT restricts write_file and patch to a directory prefix; writes outside require approval.',
    ...
    'agentx import restores a session export or profile archive produced by sessions export or profile export.',

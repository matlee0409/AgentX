...
# Configuration
REPO_URL_SSH="git@github.com:matlee0409/AgentX.git"
REPO_URL_HTTPS="https://github.com/matlee0409/AgentX.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/matlee0409/AgentX/main/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"

...
sidebar_position: 12
title: "Google Chat"
description: "Set up AgentX Agent as a Google Chat bot using Cloud Pub/Sub"
---

# Google Chat Setup

Connect AgentX Agent to Google Chat as a bot. The integration uses Cloud Pub/Sub
...
Install the dependencies the Google Chat adapter needs (no AgentX extra is currently published — install them directly):

...
# Configuration
REPO_URL_SSH="git@github.com:NousResearch/agentx-agent.git"
REPO_URL_HTTPS="https://github.com/NousResearch/agentx-agent.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://agentx-agent.nousresearch.com/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"

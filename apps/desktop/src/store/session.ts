...
import type { SessionInfo, UsageStats } from '@/types/agentx'
...
function workspaceCwdKey(connection: AgentXConnection | null = $connection.get()): string {
...
export const $connection = atom<AgentXConnection | null>(null)
...
export const setConnection = (next: Updater<AgentXConnection | null>) => updateAtom($connection, next)

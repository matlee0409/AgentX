...
def _get_model_metadata_cache_path() -> Path:
    ...
    return get_agentx_home() / "cache" / "openrouter_model_metadata.json"
...
# Minimum context length required to run AgentX Agent.  Models with fewer
...
def _get_context_cache_path() -> Path:
    ...
    from agentx_constants import get_agentx_home
    return get_agentx_home() / "context_length_cache.yaml"
...
def get_model_context_length(
    ...
    if effective_provider in {"copilot", "copilot-acp", "github-copilot"}:
        try:
            from agentx_cli.models import get_copilot_model_context

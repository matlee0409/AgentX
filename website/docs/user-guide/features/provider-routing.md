...
When using [OpenRouter](https://openrouter.ai) as your LLM provider, AgentX Agent supports **provider routing** — fine-grained control over which underlying AI providers handle your requests and how they're prioritized.

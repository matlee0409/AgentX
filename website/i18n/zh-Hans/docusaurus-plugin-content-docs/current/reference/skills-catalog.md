...
sidebar_position: 5
title: "内置技能目录"
description: "随 AgentX Agent 附带的内置技能目录"
---
...
| [`agentx-agent`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-agentx-agent) | 配置、扩展或贡献 AgentX Agent。 | `autonomous-ai-agents/agentx-agent` |

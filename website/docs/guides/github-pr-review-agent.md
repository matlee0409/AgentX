...
┌───────────────────────────────────────────────────────────────────┐
│                                                                   │
│   Cron Timer  ──▶  AgentX Agent  ──▶  GitHub API  ──▶  Review     │
...
- **AgentX Agent installed** — see the [Installation guide](/getting-started/installation)
...
```
Run: gh pr list --repo NousResearch/agentx-agent --state open --limit 3
```
...
Run: gh pr diff 3888 --repo NousResearch/agentx-agent
```
...
- **[Build a Plugin](/guides/build-a-agentx-plugin)** — wrap the review logic into a shareable plugin

---
name: plan
description: "Plan mode: write an actionable markdown plan to .agentx/plans/, no execution. Bite-sized tasks, exact paths, complete code."
version: 2.0.0
author: AgentX Agent (writing-craft adapted from obra/superpowers)
license: MIT

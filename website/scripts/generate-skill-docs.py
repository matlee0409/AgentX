...
def rewrite_relative_links(body: str, meta: dict[str, Any]) -> str:
    ...
    base = f"https://github.com/NousResearch/agentx-agent/blob/main/{source_dir}/{meta['rel_path']}"
...
def render_skill_page(
    ...
    agentx_meta = (fm.get("metadata") or {}).get("agentx") or {}
    tags = agentx_meta.get("tags") or []
    related = agentx_meta.get("related_skills") or []
...
def build_catalog_md_bundled(entries: list[tuple[dict[str, Any], dict[str, Any]]]) -> str:
    ...
    lines = [
        ...
        'description: "Catalog of bundled skills that ship with AgentX Agent"',
        "---",
        "",

...
the shared /blueprint command handler (agentx_cli/blueprint_cmd.py), and
...
class TestRenderers:
    ...
    def test_catalog_entry_has_all_surfaces(self):
        ...
        assert entry["appUrl"].startswith("agentx://")
...
class TestCommandHandler:
    ...
    def test_name_match_is_forgiving(self, isolated_home):
        from agentx_cli.blueprint_cmd import handle_blueprint_command, match_blueprint

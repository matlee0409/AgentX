---
title: "AgentX Agent Skill Authoring — Author in-repo SKILL"
...
- [ ] `name`, `description`, `version`, `author`, `license`, `metadata.agentx.{tags, related_skills}` all present

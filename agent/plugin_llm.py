...
Plugins built on AgentX Agent often need to make their own LLM calls
...
:class:`~agentx_cli.plugins.PluginContext`:
...
class PluginLlm:
    ...
    Instances are constructed by :class:`agentx_cli.plugins.PluginContext`

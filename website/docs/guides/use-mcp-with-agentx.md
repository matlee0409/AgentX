...
description: "A practical guide to connecting MCP servers to AgentX Agent, filtering their tools, and using them safely in real workflows"
---

# Use MCP with AgentX

This guide shows how to actually use MCP with AgentX Agent in day-to-day workflows.

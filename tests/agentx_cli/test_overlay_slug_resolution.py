...
def test_copilot_uses_agentx_slug():
...
def test_kimi_for_coding_overlay_uses_agentx_slug():
...
def test_kilo_overlay_uses_agentx_slug():
...
def test_mapped_provider_credential_pool_visibility(monkeypatch):
    ...
    monkeypatch.setattr(
        "agentx_cli.auth._load_auth_store",

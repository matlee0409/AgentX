...
import { getAgentXConfigDefaults, getAgentXConfigRecord, saveAgentXConfig } from '@/agentx'
...
export function SettingsView({ gateway, onClose, onConfigSaved, onMainModelChanged }: SettingsPageProps) {
  ...
  const exportConfig = async () => {
    try {
      const cfg = await getAgentXConfigRecord()
  ...
  const resetConfig = async () => {
    ...
    try {
      await saveAgentXConfig(await getAgentXConfigDefaults())
      triggerHaptic('success')
      onConfigSaved?.()
    } catch (err) {

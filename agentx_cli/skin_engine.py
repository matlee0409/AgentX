"""AgentX CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.agentx/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "AgentX Agent"          # Banner title, status display
...
.. code-block:: python
    ...
    from agentx_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "AgentX Agent"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to AgentX Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",

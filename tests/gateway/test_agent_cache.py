...
class TestAgentConfigSignature:
    ...
    def test_same_config_same_signature(self):
        ...
        sig2 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["agentx-telegram"], "")
        assert sig1 == sig2
    ...
    def test_toolset_change_different_signature(self):
        ...
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["agentx-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["agentx-discord"], "")
        assert sig1 != sig2
...
class TestAgentCacheLifecycle:
    ...
    def test_cache_miss_on_model_change(self):
        ...
        old_sig = runner._agent_config_signature("anthropic/claude-sonnet-4", runtime, ["agentx-telegram"], "")
        agent1 = AIAgent(
            model="anthropic/claude-sonnet-4", api_key="test",
            base_url="https://openrouter.ai/api/v1", provider="openrouter",
            max_iterations=5, quiet_mode=True, skip_context_files=True,
        ...
        new_sig = runner._agent_config_signature("anthropic/claude-opus-4.6", runtime, ["agentx-telegram"], "")
...
class TestAgentConfigSignatureUserId:
    ...
    def test_signature_changes_with_user_id(self):
        ...
        sig_a = GatewayRunner._agent_config_signature(
            "claude-sonnet-4", runtime, ["agentx-telegram"], "", user_id="7654321"
        )
        sig_b = GatewayRunner._agent_config_signature(
            "claude-sonnet-4", runtime, ["agentx-telegram"], "", user_id="491827364"
        )
        assert sig_a != sig_b

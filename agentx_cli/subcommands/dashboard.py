"""``agentx dashboard`` subcommand parser.
...
def build_dashboard_parser(
    ...
    dashboard_parser = subparsers.add_parser(
        ...
        description="Launch the AgentX Agent web dashboard for managing config, API keys, and sessions",
    )
    ...
    # for `agentx dashboard` cmdlines and SIGTERM them directly — the same
    # path `agentx update` uses to clean up stale dashboards.
    dashboard_parser.add_argument(
        "--stop",
        action="store_true",
        help="Stop all running agentx dashboard processes and exit",
    )
    dashboard_parser.add_argument(
        "--status",
        action="store_true",
        help="List running agentx dashboard processes and exit",
    )

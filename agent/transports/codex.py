...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around AgentX's web-provider config and
        ...
        # native search engine for xAI sessions instead of AgentX's
        # configured web provider (Tavily/etc.), and those results bypass
        # AgentX's tool-trace / citation plumbing (they arrive baked into the

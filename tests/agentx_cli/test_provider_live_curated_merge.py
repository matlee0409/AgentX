...
from agentx_cli.models import _PROVIDER_MODELS, provider_model_ids
...
class TestGenericProviderLiveCuratedMerge:
    ...
    def test_live_models_merged_with_curated(self):
        ...
        with (
            ...
            patch("agentx_cli.auth.resolve_api_key_provider_credentials", return_value={"api_key": "k", "base_url": ""}),
        ):
    ...
    def test_no_duplicate_models(self):
        ...
        with (
            patch("providers.get_provider_profile", return_value=profile),
            patch("agentx_cli.auth.resolve_api_key_provider_credentials", return_value={"api_key": "k", "base_url": ""}),
            patch.dict("agentx_cli.models._PROVIDER_MODELS", {"zai": curated}),
        ):
            result = provider_model_ids("zai")
    ...
    def test_empty_curated_returns_live_only(self):
        ...
        with (
            patch("providers.get_provider_profile", return_value=profile),
            patch("agentx_cli.auth.resolve_api_key_provider_credentials", return_value={"api_key": "k", "base_url": ""}),
            patch.dict("agentx_cli.models._PROVIDER_MODELS", {"zai": []}),
        ):
            result = provider_model_ids("zai")
    ...
    def test_live_empty_falls_back_to_curated(self):
        ...
        with (
            ...
            patch("agentx_cli.auth.resolve_api_key_provider_credentials", return_value={"api_key": "k", "base_url": ""}),
            patch.dict("agentx_cli.models._PROVIDER_MODELS", {"zai": curated}),
            patch("agentx_cli.models._merge_with_models_dev", return_value=curated),
        ):
            result = provider_model_ids("zai")
...
class TestValidateRequestedModelCuratedFallback:
    ...
    def test_model_in_curated_but_not_live_is_accepted(self):
        ...
        with (
            patch("agentx_cli.models.fetch_api_models", return_value=live_models),
            patch.dict("agentx_cli.models._PROVIDER_MODELS", {"zai": curated}),
        ):
    ...
    def test_model_in_live_is_accepted_without_curated_check(self):
        ...
        with patch("agentx_cli.models.fetch_api_models", return_value=live_models):
    ...
    def test_curated_fallback_is_scoped_to_the_current_provider(self):
        ...
        with (
            patch("agentx_cli.models.fetch_api_models", return_value=live_models),
            patch.dict(
                "agentx_cli.models._PROVIDER_MODELS",

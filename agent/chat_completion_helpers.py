...
from agentx_cli.timeouts import get_provider_request_timeout, get_provider_stale_timeout
from agentx_constants import PARTIAL_STREAM_STUB_ID, FINISH_REASON_LENGTH
...
def interruptible_api_call(agent, api_kwargs: dict):
    ...
    if _ttfb_timeout <= 0:
        ...
        _ttfb_disable_above = _env_float("AGENTX_CODEX_TTFB_DISABLE_ABOVE_TOKENS", 25_000.0)
        ...
        if (
            ...
            logger.info(
                ...
                "Set AGENTX_CODEX_TTFB_STRICT=1 to force early reconnects.",
...
def try_activate_fallback(agent, reason: "FailoverReason | None" = None) -> bool:
    ...
    try:
        ...
        if not fb_api_key_hint:
            ...
            # _normalize_custom_provider_entry in agentx_cli/config.py).
...
def interruptible_streaming_api_call(agent, api_kwargs: dict, *, on_first_delta=None):
    ...
    # the user explicitly set AGENTX_STREAM_STALE_TIMEOUT.

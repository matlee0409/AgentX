 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `agentx_cli/web_server.py`.
 */
...
/**
 * Nous Blue — the inverted "light mode" AgentX look, ported from the
 ...
 * nousnet-web's <body> is white; agentx-agent's App root is `bg-black`,

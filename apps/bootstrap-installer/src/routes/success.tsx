...
/*
 * Success screen. AGENTX AGENT wordmark stays as the visual anchor
 ...
 * AgentX.exe doesn't exist). We catch the Tauri error and surface it
...
export default function Success() {
  ...
  return (
    <div className="agentx-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
      ...
      >
        <Rocket size={18} />
        {launching ? 'Launching…' : 'Launch AgentX'}
      </Button>

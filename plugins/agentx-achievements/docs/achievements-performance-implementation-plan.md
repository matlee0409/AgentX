...
- Snapshot persisted at `~/.agentx/plugins/agentx-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.agentx/plugins/agentx-achievements/scan_checkpoint.json`.

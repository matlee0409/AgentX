...
sidebar_position: 2
title: "添加工具"
description: "如何向 AgentX Agent 添加新工具——schema、handler、注册与 toolset"
---
...
- [构建 AgentX 插件](/guides/build-a-agentx-plugin)
...
如果你的工具需要 API 密钥，将其添加到 `agentx_cli/config.py`：
...
- [ ] 可选：已将 API 密钥添加到 `agentx_cli/config.py` 的 `OPTIONAL_ENV_VARS`

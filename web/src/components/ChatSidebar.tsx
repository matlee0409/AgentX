...
import { api, AGENTX_BASE_PATH, buildWsAuthParam } from "@/lib/api";
...
export function ChatSidebar({
  ...
  // /api/events in agentx_cli/web_server.py for the broadcast hop.
  //
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      ws = new WebSocket(
        `${proto}//${window.location.host}${AGENTX_BASE_PATH}/api/events?${qs.toString()}`,
      );

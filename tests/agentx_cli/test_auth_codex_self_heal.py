...
import agentx_cli.auth as auth
from agentx_cli.auth import AuthError, _refresh_codex_auth_tokens, resolve_codex_runtime_credentials
...
def test_self_heals_missing_singleton_access_token_from_codex_cli(tmp_path, monkeypatch):
    ...
    stored = json.loads((agentx_home / "auth.json").read_text())

...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateAgentX: "AgentX frissítése",
    updatingAgentX: "AgentX frissítése…",
  ...
  achievements: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet a AgentXt",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in AgentX Agent ☤",
    },
  },
  kanban: {

...
def worker_loop(worker_id: int, agentx_home: str, result_file: str) -> None:
...
def reclaimer_loop(agentx_home: str, result_file: str) -> None:
    os.environ["AGENTX_HOME"] = agentx_home
    os.environ["HOME"] = agentx_home
    sys.path.insert(0, WT)
    from agentx_cli import kanban_db as kb
...
def main():
    home = tempfile.mkdtemp(prefix="agentx_reclaim_race_")

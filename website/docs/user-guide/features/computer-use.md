...
AgentX Agent can drive your desktop — clicking, typing, scrolling,
...
**session id** (something like `agentx-3a7b9c14d2e8`); the cursor's
...
AgentX intentionally keeps its skill (`skills/computer-use/SKILL.md`)
...
- **AgentX spawns its own `cua-driver mcp` child over stdio** — it does
...
- **AgentX-side skill** — `skills/computer-use/SKILL.md` — teaches the

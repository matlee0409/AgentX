...
For how to ship skills in your own plugin, see [Build a AgentX Plugin → Bundle skills](/guides/build-a-agentx-plugin#bundle-skills).
...
agentx config show | grep '^skills\.config'
```

...
export interface EnvVarInfo {
  ...
  // in agentx_cli/provider_catalog.py). When present, the Keys tab groups by
...
export type AgentXConfigRecord = Record<string, unknown>
...
// folders. Mirrors agentx_cli/projects_db.Project.to_dict().

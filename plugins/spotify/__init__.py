...
``_check_spotify_available()`` — when the user has not run ``agentx auth
spotify``, the tools remain registered (so they appear in ``agentx
...
The Spotify auth flow (``agentx auth spotify``), CLI plumbing, and docs

...
const branchActionLabel = (branch: AgentXGitBranch, copy: BranchActionCopy) => {
...
interface CodingStatusRowProps {
  ...
  onListBranches?: () => Promise<AgentXGitBranch[]>
...
export const CodingStatusRow = memo(function CodingStatusRow({
  ...
  const [branches, setBranches] = useState<AgentXGitBranch[]>([])
  ...
  const convertBranch = async (branch: AgentXGitBranch) => {

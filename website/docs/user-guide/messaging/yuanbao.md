...
sidebar_position: 16
title: "Yuanbao"
description: "Connect AgentX Agent to the Yuanbao enterprise messaging platform via WebSocket gateway"
---
...
4. Consider enabling verbose logging: `AGENTX_LOG_LEVEL=debug`

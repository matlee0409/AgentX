...
Mounted at /api/plugins/agentx-achievements/ by AgentX dashboard.
"""
...
try:
    ...
    import os as _os
    def get_agentx_home() -> Path:  # type: ignore[misc]
...
def state_path() -> Path:
    return get_agentx_home() / "plugins" / "agentx-achievements" / "state.json"


def snapshot_path() -> Path:
    return get_agentx_home() / "plugins" / "agentx-achievements" / "scan_snapshot.json"


def checkpoint_path() -> Path:
    return get_agentx_home() / "plugins" / "agentx-achievements" / "scan_checkpoint.json"

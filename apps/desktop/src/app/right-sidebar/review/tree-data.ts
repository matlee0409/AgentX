import type { AgentXReviewFile } from '@/global'
...
export function buildReviewFlatList(files: AgentXReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: AgentXReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')

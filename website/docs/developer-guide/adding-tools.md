...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to AgentX Agent — schemas, handlers, registration, and toolsets"
---
...
- [Build a AgentX Plugin](/guides/build-a-agentx-plugin)
...
If your tool requires an API key, add it to `agentx_cli/config.py`:
...
- [ ] Optional: API key added to `OPTIONAL_ENV_VARS` in `agentx_cli/config.py`

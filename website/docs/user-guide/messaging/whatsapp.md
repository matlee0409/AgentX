...
sidebar_position: 5
title: "WhatsApp"
description: "Set up AgentX Agent as a WhatsApp bot via the built-in Baileys bridge"
---
...
- Agent responses are prefixed with "⚕ **AgentX Agent**" by default. You can customize or disable this in `config.yaml`:

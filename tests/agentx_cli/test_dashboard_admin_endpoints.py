...
class TestMcpEndpoints:
    ...
    def _setup(self, _isolate_agentx_home):
...
class TestMemoryEndpoints:
    ...
    def _setup(self, _isolate_agentx_home):
        ...
        (get_agentx_home() / "memories").mkdir(parents=True, exist_ok=True)
...
class TestSystemStatsEndpoint:
    ...
    def test_stats_shape(self):
        ...
        for key in ("os", "arch", "hostname", "python_version", "agentx_version"):
...
class TestSkillsHubPreviewEndpoint:
    ...
    def test_preview_returns_skill_md_text(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "agentx_cli.skills_hub._resolve_source_meta_and_bundle",
...
class TestDebugShareEndpoint:
    ...
    def test_returns_structured_urls(self, monkeypatch):
        import agentx_cli.debug as dbg
        ...
        monkeypatch.setattr("agentx_cli.dump.run_dump", lambda a: None)
...
class TestToolsConfigEndpoints:
    ...
    def test_post_setup_spawns_action(self, monkeypatch):
        ...
        monkeypatch.setattr(ws, "_spawn_agentx_action", _fake_spawn)
        r = self.client.post(

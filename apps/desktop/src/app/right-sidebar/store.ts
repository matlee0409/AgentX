...
const TAKEOVER_KEY = 'agentx.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which AgentX can't clear via the API — the user
 *  sees exactly what runs instead of AgentX silently deleting their creds. */

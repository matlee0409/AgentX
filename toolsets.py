...
_AGENTX_CORE_TOOLS = [
    ...
    "terminal", "process",
    # Read the desktop GUI's embedded terminal pane (gated on AGENTX_DESKTOP
...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "enable in `agentx tools` → X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    },
    ...
    "coding": {
        ...
        # non-configurable-toolset recovery loop in agentx_cli/tools_config.py).
        "posture": True,
    },

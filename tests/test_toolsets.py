...
class TestToolsetConsistency:
    ...
    def test_agentx_platforms_share_core_tools(self):
...
class TestDefaultPlatformWebSearchCoverage:
    def test_agentx_whatsapp_toolset_includes_web_search(self):
        assert "web_search" in resolve_toolset("agentx-whatsapp")

    def test_agentx_api_server_toolset_includes_web_search(self):
        assert "web_search" in resolve_toolset("agentx-api-server")

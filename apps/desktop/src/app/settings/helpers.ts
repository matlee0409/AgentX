import type { AgentXConfigRecord, ToolsetInfo } from '@/types/agentx'
...
export function getNested(obj: AgentXConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: AgentXConfigRecord, path: string, value: unknown): AgentXConfigRecord {
...
function personalityOptions(config: AgentXConfigRecord): string[] {

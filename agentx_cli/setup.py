...
_DOCS_BASE = "https://github.com/matlee0409/AgentX/wiki"
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://github.com/matlee0409/AgentX/wiki/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://github.com/matlee0409/AgentX/wiki/user-guide/messaging/webhooks/#configuring-routes")
    print()

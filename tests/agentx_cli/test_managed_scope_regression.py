...
def test_user_config_overrides_default(agentx_home, monkeypatch):
    from agentx_cli.config import load_config, cfg_get
...
def test_env_expansion_in_user_config(agentx_home, monkeypatch):
    from agentx_cli.config import load_config, cfg_get
...
def test_no_managed_dir_means_user_value_wins(agentx_home):
...
def test_user_env_overrides_shell(tmp_path, monkeypatch):
    ...
    load_agentx_dotenv(agentx_home=str(home))

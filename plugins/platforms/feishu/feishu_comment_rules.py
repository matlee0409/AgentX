...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_agentx_home()`` helper (AGENTX_HOME-aware and
...
RULES_FILE = get_agentx_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_agentx_home() / "feishu_comment_pairing.json"
